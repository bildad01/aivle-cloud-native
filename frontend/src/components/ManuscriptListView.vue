...
export default {
    ...
    setup() {
        const headers = ref([
            ...
            { title: "manuscriptTitle", key: "manuscriptTitle" },
            { title: "manuscriptContent", key: "manuscriptContent" },
            { title: "manuscriptStatus", key: "manuscriptStatus" },
            { title: "lastModifiedAt", key: "lastModifiedAt" },
            { title: "autorId", key: "autorId" },
        ]);
