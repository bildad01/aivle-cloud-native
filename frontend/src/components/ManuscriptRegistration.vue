<template>
    ...
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <String label="AuthorId" v-model="value.authorId" :editMode="editMode"/>
            ...
            <Date label="LastModifiedAt" v-model="value.lastModifiedAt" :editMode="editMode"/>
...
export default {
    name: 'ManuscriptRegistrationCommand',
    components:{
    },
    props: {},
    data: () => ({
    ...
    created() {
        ...
        this.value.content = '';
        this.value.status = '';
        this.value.lastModifiedAt = '2025-06-27';
        this.value.summary = '';
        this.value.keywords = '';
    },
    watch: {
    ...
    methods: {
        manuscriptRegistration() {
            this.$emit('manuscriptRegistration', this.value);
        },
        close() {
